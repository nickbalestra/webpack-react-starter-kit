...
/***/ function(module, exports, __webpack_require__) {
	...
	var keyMirror = function keyMirror(obj) {
	  var ret = {};
	  var key;
	  !(_instanceof(obj, Object) && !Array.isArray(obj)) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'keyMirror(...): Argument must be an object.') : invariant(false) : undefined;
	  for (key in obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var standardReleaser = function standardReleaser(instance) {
	  var Klass = this;
	  !_instanceof(instance, Klass) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Trying to release an instance into a pool of a different type.') : invariant(false) : undefined;
	  instance.destructor();
...
/***/ function(module, exports) {
	...
	function isNode(object) {
	  return !!(object && (typeof Node === 'function' ? _instanceof(object, Node) : (typeof object === 'undefined' ? 'undefined' : _typeof(object)) === 'object' && typeof object.nodeType === 'number' && typeof object.nodeName === 'string'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  mountComponent: function mountComponent(rootID, transaction, context) {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      ...
	      if (inst.render == null) {
	        ...
	        process.env.NODE_ENV !== 'production' ? warning(Component.prototype && Component.prototype.isReactComponent || !canInstantiate || !_instanceof(inst, Component), '%s(...): React component classes must extend React.Component.', Component.displayName || Component.name || 'Component') : undefined;
	      }
	    }
	  ...
	  getPublicInstance: function getPublicInstance() {
	    var inst = this._instance;
	    if (_instanceof(inst, StatelessComponent)) {
	      return null;
	    }
	    return inst;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isTextComponent(component) {
	  return _instanceof(component, textComponentClass);
	}
	...
	var ReactClass = {
	  ...
	  createClass: function createClass(spec) {
	    var Constructor = function Constructor(props, context, updater) {
	      ...
	      if (process.env.NODE_ENV !== 'production') {
	        process.env.NODE_ENV !== 'production' ? warning(_instanceof(this, Constructor), 'Something is calling a React component directly. Use a factory or ' + 'JSX instead. See: https://fb.me/react-legacyfactory') : undefined;
	      }
